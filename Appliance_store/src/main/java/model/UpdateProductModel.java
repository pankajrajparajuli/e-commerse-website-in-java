...
public class UpdateProductModel implements Serializable {
	...
	public UpdateProductModel(int product_id, String product_name, String description,Double price,int stock,String imagePart ) {
		super();
